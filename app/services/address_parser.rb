class AddressParser
  ...
  private
    ...
    def latitude
      parsed_address["results"].present? && parsed_address["results"][0]["geometry"]["location"]["lat"]
    end

    def longitude
      parsed_address["results"].present? && parsed_address["results"][0]["geometry"]["location"]["lng"]
    end
