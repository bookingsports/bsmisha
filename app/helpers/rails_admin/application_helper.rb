  ...
  module ApplicationHelper
    ...
    def edit_user_link
      ...
      link_to url_for(action: edit_action.action_name, model_name: abstract_model.to_param, id: _current_user.id, controller: 'rails_admin/main') do
        html = []
        html << image_tag(_current_user.avatar.url, alt: '', width: 32, height: 32, class: 'avatar') if _current_user.avatar.present?
        html << content_tag(:span, _current_user.short_name)
        html.join.html_safe
      end
    end
